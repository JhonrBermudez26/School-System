  ...
  if (!meeting) {
    return (
      <div className="bg-white rounded-3xl shadow-xl p-8 sm:p-12 text-center border border-gray-100">
        <div className="w-20 h-20 sm:w-24 sm:h-24 bg-gradient-to-br from-blue-100 to-emerald-200 rounded-full flex items-center justify-center mx-auto mb-6 shadow-lg">
          <Video className="h-10 w-10 sm:h-12 sm:w-12 text-blue-600" strokeWidth={1.5} />
        </div>
        <h3 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-3">
          No hay reunión activa
        </h3>
        <p className="text-gray-600 mb-2 text-base sm:text-lg max-w-md mx-auto">
          Inicia una videollamada para conectarte con tus estudiantes
        </p>
        <div className="inline-flex items-center gap-2 px-4 py-2 bg-blue-50 text-blue-700 rounded-full text-sm font-semibold mb-8">
    ...
    <div className="space-y-5">
      ...
      <div className="bg-blue-50 rounded-2xl p-6 border border-blue-200">
        <h4 className="font-bold text-blue-900 mb-3 flex items-center gap-2">
          ...
          Consejos para una mejor reunión
        </h4>
        <ul className="space-y-2 text-sm text-blue-800">
          <li className="flex items-start gap-2">
            <Check className="h-4 w-4 mt-0.5 flex-shrink-0 text-blue-600" />
            <span>Comparte el enlace con tus estudiantes antes de iniciar</span>
          </li>
          <li className="flex items-start gap-2">
            <Check className="h-4 w-4 mt-0.5 flex-shrink-0 text-blue-600" />
            <span>Usa auriculares para evitar eco y mejor calidad de audio</span>
          </li>
          <li className="flex items-start gap-2">
            <Check className="h-4 w-4 mt-0.5 flex-shrink-0 text-blue-600" />
            <span>Puedes compartir tu pantalla usando el botón en la barra inferior</span>
          </li>
          <li className="flex items-start gap-2">
            <Check className="h-4 w-4 mt-0.5 flex-shrink-0 text-blue-600" />
            <span>Silencia a los participantes si hay mucho ruido de fondo</span>
          </li>
        </ul>
      </div>
    </div>
