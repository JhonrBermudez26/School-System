            ...
            <div className="flex items-center gap-3 mb-3">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm sm:text-base mt-1">
                  Gestiona tus clases, publicaciones y archivos
                </p>
              </div>
            </div>
          </div>
          ...
          {asignaciones.length === 0 ? (
            <div className="bg-white rounded-2xl shadow-xl p-12 sm:p-16 text-center border border-gray-100">
              ...
              <p className="text-gray-600 max-w-md mx-auto">
                Cuando tengas asignaciones de clases, aparecerán aquí para que puedas gestionarlas
              </p>
            </div>
          ) : (
                    ...
                    <div className="flex items-center gap-4 mb-4">
                      <div className="flex items-center gap-2 text-gray-700">
                        ...
                        <div>
                          ...
                          <p className="text-sm font-bold text-gray-900">{clase.students_count}</p>
                        </div>
                      </div>
                    </div>
