...
export default function Horario() {
    ...
    const hasSchedule = teacher_timetable_slots.length > 0;

    return (
        <Layout title="Mi Horario - Profesor">
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-2xl font-bold text-gray-800">
                                        {teacher_timetable_slots.length}
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-white rounded-xl shadow-md p-5 border border-gray-100">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-2xl font-bold text-gray-800">
                                        {new Set(teacher_timetable_slots.map(ts => ts.group_id)).size}
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-white rounded-xl shadow-md p-5 border border-gray-100">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-2xl font-bold text-gray-800">
                                        {new Set(teacher_timetable_slots.map(ts => ts.subject_id)).size}
                                    </p>
                                </div>
                            </div>
                        </div>
                                                ...
                                                <div key={day}>
                                                    ...
                                                    {cell ? (
                                                        <div className="bg-blue-50 p-3 rounded-lg text-sm border border-blue-100 hover:bg-blue-100 transition-colors">
                                                            ...
                                                            <div className="text-xs text-gray-700 mt-1.5 truncate flex items-center justify-center gap-1">
