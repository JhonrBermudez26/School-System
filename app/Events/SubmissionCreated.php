...
class SubmissionCreated implements ShouldBroadcast
{
    ...
    public function broadcastWith(): array
    {
        return [
            ...
            'is_late' => $this->submission->is_late,
            'members_count' => $this->submission->members->count(),
            'files_count' => $this->submission->files->count(),
            'message' => $this->submission->student->name . ' ha entregado la tarea: ' . $this->submission->task->title,
